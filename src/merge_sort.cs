...
namespace merge_sort
{
    class Program
    {
        ...
        {
            /// <summary>
            /// Script entry point and test case for MergeSort method
            /// </summary>
            /// <returns>
            /// None
            /// </returns>
            ...
            // check output
            int[] correctSortedArray = {-1, 0, 2, 5, 6, 7, 9, 10, 54, 101};
            Console.WriteLine($"Merge Sort Method Success: {sortedArray.SequenceEqual(correctSortedArray)}");
        }
